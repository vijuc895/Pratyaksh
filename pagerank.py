...
configuration.api_key['Apikey'] = 'd3c1b4c4-494b-48a6-a4f6-2d440f64b1a9'
...
for file in files:
    ...
    somedata.append(summarize(text).replace('\n',' '))
    #somedata.append(tags)
    
    #print("**************************************************")
    somedata.append(keywords(text).split('\n'))
    #print("**************************************************")
...
for i in data:
    ...
    print('\n')
    print("Summary::",data[count-1][0])
    print('\n')
    print("Tags::",data[count-1][1])
